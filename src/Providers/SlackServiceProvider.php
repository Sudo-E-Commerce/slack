...
namespace Sudo\Slack\Providers;
    ...
    */
    public function publish()
    {
        if ($this->app->runningInConsole()) {
            ...
            // Chạy riêng
            $this->publishes($all, 'sudo/slack');
            $this->publishes($assets, 'sudo/slack/assets');
            $this->publishes($config, 'sudo/slack/config');
            $this->publishes($view, 'sudo/slack/view');
